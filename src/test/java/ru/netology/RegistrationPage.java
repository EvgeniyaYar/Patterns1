...
//        $("[data-test-id='city'] input.input__control").setValue(info.getCity());
        $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.DELETE);
        $("[data-test-id='date'] input").setValue(String.valueOf(info.getDate().format(DateTimeFormatter.ofPattern("dd,MM.yyyy"))));
